		...
		<view class="container">
            <view class="detail-content">
				...
				<view class="detail-list-item" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 2rpx 0","borderColor":"#fff","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid","height":"100rpx"}'>
					...
					<view class="text" :style='{"color":"rgba(68, 68, 68, 1)","textAlign":"right","fontSize":"28rpx"}'>{{detail.username}}</view>
				</view>
				<view class="detail-list-item" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 2rpx 0","borderColor":"#fff","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid","height":"100rpx"}'>
					<view class="lable" :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(68, 68, 68, 1)","textAlign":"center"}'>密码：</view>
					<view class="text" :style='{"color":"rgba(68, 68, 68, 1)","textAlign":"right","fontSize":"28rpx"}'>{{detail.password}}</view>
				</view>
				<view class="detail-list-item" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 2rpx 0","borderColor":"#fff","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid","height":"100rpx"}'>
					<view class="lable" :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(68, 68, 68, 1)","textAlign":"center"}'>角色：</view>
					<view class="text" :style='{"color":"rgba(68, 68, 68, 1)","textAlign":"right","fontSize":"28rpx"}'>{{detail.role}}</view>
				</view>
