<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商户名称" prop="zhanghao">
          <el-input v-model="ruleForm.zhanghao" 
              placeholder="商户名称" clearable  :readonly="ro.zhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商户名称" prop="zhanghao">
              <el-input v-model="ruleForm.zhanghao" 
