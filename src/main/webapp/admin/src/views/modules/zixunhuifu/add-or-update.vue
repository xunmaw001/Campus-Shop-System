    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="咨询回复" prop="zixunhuifu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="咨询回复"
                  v-model="ruleForm.zixunhuifu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zixunhuifu" label="咨询回复" prop="zixunhuifu">
                    <span>{{ruleForm.zixunhuifu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
